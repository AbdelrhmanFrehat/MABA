...
public class EndAiSessionCommandHandler : IRequestHandler<EndAiSessionCommand, AiSessionDto>
{
    private readonly IApplicationDbContext _context;

    public EndAiSessionCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<AiSessionDto> Handle(EndAiSessionCommand request, CancellationToken cancellationToken)
    {
