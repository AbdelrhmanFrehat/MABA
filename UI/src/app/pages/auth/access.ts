...
@Component({
            ...
            <div class="auth-container">
                ...
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <h1>{{ 'auth.accessDenied' | translate }}</h1>
                        <p>{{ 'auth.accessDeniedMessage' | translate }}</p>
                    </div>
                    ...
                    <div class="action-buttons">
                        ...
                        <p-button 
                            [label]="langService.language === 'ar' ? 'تسجيل الدخول' : 'Login'" 
    ...
    styles: [`
        :host {
            ...
            --shadow-warning: 0 0 40px rgba(237, 137, 54, 0.4);
        }
