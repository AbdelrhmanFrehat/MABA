            ...
            <div class="grid grid-cols-12 gap-4 justify-between mt-20 md:mt-0">
                <div class="col-span-12 lg:col-span-4 p-0 md:p-4">
                    <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all" style="border-radius: 10px">
                        ...
                        <div class="flex items-center justify-center w-24 h-24 mx-auto rounded-full bg-blue-100"><i class="pi pi-gift text-4xl! text-blue-500"></i></div>
                ...
                <div class="col-span-12 lg:col-span-4 p-0 md:p-4 mt-6 md:mt-0">
                    <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all" style="border-radius: 10px">
                        ...
                        <div class="flex items-center justify-center w-24 h-24 mx-auto rounded-full bg-green-100"><i class="pi pi-bolt text-4xl! text-green-500"></i></div>
                        <div class="my-8 flex flex-col items-center gap-4">
                            <div class="flex items-center">
                ...
                <div class="col-span-12 lg:col-span-4 p-0 md:p-4 mt-6 md:mt-0">
                    <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all" style="border-radius: 10px">
                        ...
                        <div class="flex items-center justify-center w-24 h-24 mx-auto rounded-full bg-purple-100"><i class="pi pi-building text-4xl! text-purple-500"></i></div>
                        <div class="my-8 flex flex-col items-center gap-4">
                            <div class="flex items-center">
